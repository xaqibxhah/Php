...
<body>
  ...
  <div class="navbar">
    ...
    <a href="./login.php">Account <i class="bi bi-person-fill"></i></a>
  </div>
  ...
  <div class="main row gap-2 ps-5 justify-content-center">


    <?php foreach ($result as $post): ?>

      <div class="card col-md-3 mt-3 ps-3 pt-2">
        ...
        <div class="icons">
          <a href="product.php?id=<?php echo $post["id"] ?>"><i class="bi bi-trash"></i></a>
